...
const calculateFinalPrice = function (basePrice, percent, taxRate) {
  return basePrice * (1 - percent / 100) * (1 + taxRate);
};
...
const checkAccess = function (username, password) {
...
console.log(checkAccess("admin", "23452345"));
...
const getTimeOfDay = function (currentTime) {
